...
class MatchmakingService {
  static Future<Map<String, dynamic>?> createMatch(String userId, {required String gameMode,required String subject,}) async {
    ...
    await matchRef.set({
      ...
      'player2Ready': false,
      'gameMode': gameMode,
      'subject': subject,// Initial ready state
    });
          ...
          if (updatedData['player2Id'] == userId) { // Confirmed we claimed it
            ...
            if (seed != null) {
              return {
                'matchId': matchId,
                'seed': seed,
                'subject': updatedData['subject'] ?? 'Physics',
              };
            }
          }
        }
